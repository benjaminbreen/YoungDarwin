export const DARWIN5_ANIMATION_MANIFEST = {
  ...
  gather: { category: 'action', duration: 3.7, lockDuration: 1.2, fade: 0.12, fallback: 'torchInspectForward' },
  ...
  swingNet: { category: 'action', duration: 1.63, lockDuration: 0.72, fade: 0.06, fallback: 'heavyToolSwing' },
