...
import { TERRAIN_SEGMENTS, TERRAIN_SIZE, terrainBiomeAt, terrainColor, terrainHeight, terrainSurfaceNoise } from '../../world/terrain';
  ...
  material.onBeforeCompile = shader => {
    ...
    shader.fragmentShader = shader.fragmentShader
      ...
      .replace(
        ...
        color = mix(color, vec3(0.045, 0.075, 0.075), wet * 0.36);
...
export function Terrain() {
  const geometry = useMemo(() => {
    ...
    for (let i = 0; i < position.count; i += 1) {
      ...
      roughness.push(biome === 'wet-basalt' ? 0.82 : 0.96);
    }
