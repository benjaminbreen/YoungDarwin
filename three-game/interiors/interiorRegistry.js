  ...
  [LAWSON_HOUSE_ZONE_ID]: {
    ...
    narrationTriggers: [
      ...
      },
      {
        ...
        position: [6.4, 0, 4.4],
        radius: 2.8,
        text: 'Lawson’s working library: shipping tracks and colony ledgers shelved above the damp floor, with London caricatures and English flower prints holding the walls.',
      },
      {
        id: 'private-quarters',
        position: [-5.25, 0, -4.0],
        radius: 3.0,
        text: 'Lawson’s sleeping room is barer than his office: a narrow cot, a washstand, and a chest of drawers, everything an arm’s reach from everything else.',
      },
    ],
    camera: {
      minDistance: 3.0,
    ...
    lighting: {
      ...
      portals: [
        ...
        },
        {
          ...
          direct: {
            intensity: 168,
            diffuseShaftShare: 0.54,
            diffuseProjectorShare: 0.44,
            diffuseProjectorIntensity: 16,
            warmth: 0.5,
            sourceDistance: 1.8,
            distance: 10.5,
            angle: 0.52,
            ...
            castShadow: false,
            shaft: {
              panes: { count: 2, axis: [1, 0, 0], spacing: 0.7, width: 0.5, depth: 0.78, length: 6.4, opacity: 0.2, visibilityThreshold: 0.04 },
              dust: { count: 30, length: 6.4, speed: 0.06, opacity: 0.17, size: 0.08, noise: 0.2, color: '#efd09a', visibilityThreshold: 0.12 }
            }
          },
          bounce: { position: [6.5, 0.22, 5.5], direction: [0, 1, -0.1], width: 2.7, height: 1.15, intensity: 1.45, diffuseShare: 0.58 },
        },
        {
          id: 'office-east-window',
          position: [10.28, 1.56, 5.7],
          normal: [1, 0, 0],
          width: 1.5,
          height: 1.32,
          ...
          direct: {
            intensity: 186,
            diffuseShaftShare: 0.56,
            diffuseProjectorShare: 0.46,
            diffuseProjectorIntensity: 17,
            warmth: 0.54,
            sourceDistance: 1.6,
            distance: 10.5,
            angle: 0.6,
            penumbraClear: 0.44,
            penumbraOvercast: 0.76,
            decay: 1.26,
            diffuseCut: 0.14,
            castShadow: true,
            shadowMapSize: 1024,
            ...
            shaft: {
              panes: { count: 2, axis: [0, 0, 1], spacing: 0.7, width: 0.5, depth: 0.78, length: 5.6, opacity: 0.22, visibilityThreshold: 0.04 },
              dust: { count: 34, length: 5.6, speed: 0.06, opacity: 0.17, size: 0.085, noise: 0.2, color: '#e4c99a', visibilityThreshold: 0.15 }
            }
          },
          bounce: { position: [8.4, 0.24, 5.6], direction: [0, 1, 0], width: 3.0, height: 1.2, intensity: 1.5, diffuseShare: 0.6 },
        },
        {
          id: 'garden-window-a',
        ...
        {
          id: 'bedroom-west-window',
          position: [-10.28, 1.56, -3.2],
          normal: [-1, 0, 0],
          width: 1.5,
          height: 1.32,
          diffuseIntensity: 1.9,
          color: '#bbcbbf',
          goldenColor: '#efb66c',
          direct: {
            intensity: 105,
          ...
          bounce: { position: [-8.0, 0.24, -3.3], direction: [0, 1, 0], width: 2.8, height: 1.1, intensity: 1.2, diffuseShare: 0.54 }
        },
        {
          id: 'bedroom-rear-window',
          position: [-7.0, 1.56, -8.38],
          normal: [0, 0, -1],
          width: 1.4,
          height: 1.32,
          ...
          direct: {
            intensity: 92,
            diffuseProjectorShare: 0.4,
            diffuseProjectorIntensity: 11,
            warmth: 0.5,
            sourceDistance: 1.6,
            distance: 9,
            angle: 0.6,
          ...
          bounce: { position: [-7.2, 0.24, -6.4], direction: [0, 1, -0.1], width: 2.6, height: 1.1, intensity: 1.15, diffuseShare: 0.54 }
        }
      ],
      lamps: [
