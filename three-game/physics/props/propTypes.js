...
export const PROP_TYPES = {
  barrel: {
    ...
    friction: 0.62,
    restitution: 0,
    // A barrel should retain enough momentum to complete a visible roll without
    // returning to the old hollow-plastic launch response.
    linearDamping: 0.58,
    angularDamping: 0.52,
    behaviors: {
      mobility: {
        ...
        assistSpeed: 0.42,
        maxSpeed: 0.72,
        contactMaxSpeed: 0.72,
        rollingAssistSpeed: 0.58,
        rollingMaxSpeed: 1,
        floatingAssistSpeed: 0.62,
        floatingMaxSpeed: 1.05,
        pushAcceleration: 6.6,
        rotationPolicy: 'autoBarrel',
        angularMax: 1.9,
        uprightAngularMax: 0.32,
        verticalLaunchMax: 0.12,
        groundedExtraDamping: 0.12,
      },
      buoyant: {
        rideHeight: 0.12,
        strength: 34,
  ...
  postOfficeBayBarrel: {
    ...
    behaviors: {
      ...
      breakable: {
        ...
        debris: 'barrel',
        loot: {
          supplies: { provisions: 2 },
          message: 'The old post barrel bursts into weathered staves. Inside are a few dry biscuits and a small water cask — a spare meal, at least.',
          syms: '"That was rather direct, sir. Still, the biscuit is dry."',
        },
      },
    },
  },
  crate: {
    ...
    behaviors: {
      mobility: {
        ...
        maxSpeed: 0.6,
        contactMaxSpeed: 0.6,
        floatingAssistSpeed: 0.46,
        floatingMaxSpeed: 0.78,
        pushAcceleration: 7,
        contactDelay: 0.14,
        effortRampSeconds: 0.85,
        rotationPolicy: 'resistTipping',
        angularMax: 0.62,
        verticalLaunchMax: 0.1,
        groundedExtraDamping: 0.1,
        tipAssistDelay: 1.1,
        tipAssistRampSeconds: 1.6,
        tipAssistTorque: 90,
      },
      buoyant: {
        rideHeight: 0.05,
      ...
      breakable: {
        ...
        loot: {
          supplies: { provisions: 1 },
          message: 'The crate splits along its slats. Packed in straw: a sealed tin of ship’s biscuit, still good.',
  ...
  brokenWoodenCrate: {
    ...
    behaviors: {
      mobility: {
        ...
        assistSpeed: 0.3,
        maxSpeed: 0.58,
        contactMaxSpeed: 0.58,
        pushAcceleration: 6,
        rotationPolicy: 'resistTipping',
        angularMax: 0.55,
        verticalLaunchMax: 0.1,
        groundedExtraDamping: 0.14,
      },
      breakable: {
        tool: 'hammer',
        debris: 'crate',
        loot: {
          supplies: {},
          message: 'The broken crate gives way completely. Nothing worth carrying survives inside.',
  ...
  settlementBarrel: {
    ...
    behaviors: {
      mobility: {
        ...
        assistSpeed: 0.38,
        maxSpeed: 0.68,
        contactMaxSpeed: 0.68,
        rollingAssistSpeed: 0.52,
        rollingMaxSpeed: 0.92,
        pushAcceleration: 6,
        rotationPolicy: 'autoBarrel',
        angularMax: 1.8,
        uprightAngularMax: 0.32,
