...
export const modelAssets = {
  ...
  lawsonHouseInterior: {
    ...
    cacheKey: 'lawson-house-open-office-library-20260714e',
    scale: 1,
    rotation: [0, 0, 0],
    yOffset: 0,
  ...
  lawsonCandlestick: { enabled: true, preload: false, path: '/assets/models/props/interiors/period-brass-candlestick.glb', cacheKey: 'period-lighting-20260714b', scale: 1.08, rotation: [0, 0, 0], yOffset: 0, preserveMaterials: true, targetTriangles: 6000, prompt: 'Shared turned brass candlestick with a well-used tallow candle, wax drips and blackened wick.' },
