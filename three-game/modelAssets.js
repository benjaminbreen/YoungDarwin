...
export const modelAssets = {
  ...
  settlementCat: {
    ...
    cacheKey: 'settlement-cat-webp-20260818',
    scale: 1.3,
    rotation: [0, 0, 0],
    yOffset: 0.035,
    normalizeMaterials: true,
  ...
  jackoMonkey: {
    ...
    cacheKey: 'jacko-monkey-webp-20260818',
  ...
  seagull: {
    ...
    cacheKey: 'seagull-webp-20260818',
    scale: 1.15,
    rotation: [0, Math.PI, 0],
    yOffset: 0.02,
    normalizeMaterials: true,
  ...
  matureOpuntia: {
    ...
    materialEmissiveIntensity: 0.04,
    targetTriangles: 10000,
    prompt: 'Mature Floreana prickly pear, Opuntia megasperma, used for sparse tree-cactus cohorts paired with breakable juvenile plants.',
  },
  galapagoscotton: {
    enabled: true,
  ...
  scalesiavillosa: {
    enabled: true,
    preload: false,
    path: '/assets/models/nature/runtime-scalesia.glb',
    scale: 1,
    rotation: [0, 0, 0],
    yOffset: 0,
    normalizeMaterials: true,
    ...
    prompt: 'Runtime longhaired Scalesia villosa shrub, a woody daisy endemic to northern Floreana, with pale villous leaves and a compact lava-pioneer form.',
  },
  galapagosjusticia: {
    enabled: true,
    preload: false,
    path: '/assets/models/nature/runtime-purple-shrub.glb',
    scale: 1,
    rotation: [0, 0, 0],
    // The Sketchfab source extends 4.5 cm beneath its origin.
    yOffset: 0.045,
    normalizeMaterials: true,
    doubleSide: true,
    materialLift: 0.04,
    materialEmissive: '#171b12',
    materialEmissiveIntensity: 0.045,
    targetTriangles: 5000,
    prompt: 'Existing purple-flowering shrub used as a readable runtime interpretation of Floreana-present Galapagos justicia, Justicia galapagana.',
  },
  crotonscouleri: {
    enabled: true,
    preload: false,
    ...
    doubleSide: true,
    materialLift: 0.035,
    materialEmissive: '#15200f',
    materialEmissiveIntensity: 0.04,
    targetTriangles: 2000,
    prompt: 'Runtime Chala or Galapagos croton shrub, Croton scouleri, with blue-green hairy foliage for Floreana dry and transition vegetation.',
  },
  resurrectionfern: {
    enabled: true,
    preload: false,
    path: '/assets/models/nature/runtime-galapagos-fern.glb',
    scale: 1,
    rotation: [0, 0, 0],
    // Lift the modeled rhizome to account for the source origin below ground.
    yOffset: 0.065,
    normalizeMaterials: true,
    doubleSide: true,
    materialLift: 0.045,
    materialEmissive: '#102014',
    materialEmissiveIntensity: 0.04,
    targetTriangles: 3000,
    prompt: 'Runtime Floreana resurrection fern, Pleopeltis polypodioides, for sheltered humid rock, tree base, and highland forest-edge specimens.',
  },
  sesuviumportulacastrum: {
    enabled: true,
    preload: false,
    path: '/assets/models/nature/runtime-sesuvium.glb',
    scale: 1,
    rotation: [0, 0, 0],
    yOffset: 0,
    normalizeMaterials: true,
    doubleSide: true,
    materialLift: 0.04,
    materialEmissive: '#1a1d10',
    materialEmissiveIntensity: 0.04,
    targetTriangles: 35000,
    prompt: 'Runtime Galapagos carpetweed or shoreline sea purslane, Sesuvium portulacastrum, forming a low fleshy saline mat with small pink flowers.',
  },
  manzanillo: {
    enabled: true,
    preload: false,
    path: '/assets/models/nature/runtime-manzanillo.glb',
    scale: 1,
    rotation: [0, 0, 0],
    yOffset: 0,
    normalizeMaterials: true,
    doubleSide: true,
    materialLift: 0.025,
    materialEmissive: '#142012',
    materialEmissiveIntensity: 0.035,
    targetTriangles: 3000,
    prompt: 'Runtime manzanillo or poison-apple tree, Hippomane mancinella, with grey trunk, glossy evergreen crown, and a clear poisonous-plant field identity.',
  },
  ...
  lawsonCandlestick: { enabled: true, preload: false, path: '/assets/models/props/interiors/period-brass-candlestick.glb', cacheKey: 'period-lighting-webp-20260818', scale: 1.08, rotation: [0, 0, 0], yOffset: 0, preserveMaterials: true, targetTriangles: 6000, prompt: 'Shared turned brass candlestick with a well-used tallow candle, wax drips and blackened wick.' },
