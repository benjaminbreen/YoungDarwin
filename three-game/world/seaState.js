...
const BASELINE = Object.freeze({ swell: 1, chop: 1, breakers: 1 });
...
const SEA_STATES = Object.freeze({
  ...
  POST_OFFICE_BAY: { swell: 0.78, breakers: 0.9 },
  ALT_POST_OFFICE_BAY: { swell: 0.78, breakers: 0.9 },
  POST_OFFICE_BAY_3: { swell: 0.78, breakers: 0.9 },
  PUNTA_CORMORANT: { swell: 0.68, breakers: 0.85 },
  W_LAVA: { swell: 0.65, breakers: 0.82 },
  MANGROVES: { swell: 0.55, chop: 0.7, breakers: 0.7 },
  S_WETLANDS: { swell: 0.58, chop: 0.72, breakers: 0.72 },
  CORMORANT_BAY: { swell: 0.8, breakers: 0.92 },
  CORMORANT_BAY_SPLAT_TEST: { swell: 0.8, breakers: 0.92 },
  CORMORANT_BAY_TEST_2: { swell: 0.8, breakers: 0.92 },
  CORMORANT_BAY_TEST_3: { swell: 0.8, breakers: 0.92 },
  WATKINS: { swell: 0.6, chop: 0.75 },
  WATKINS_CREEK: { swell: 0.6, chop: 0.75 },

  // --- moderate: open but not exposed --------------------------------------
  POST_SCRUB_RISE: { swell: 0.78 },
  COASTAL_SCRUBLAND: { swell: 0.82 },
  PENAL_COLONY: { swell: 0.78 },
  S_HUT: { swell: 0.85 },
  S_REEFS: { swell: 0.9, breakers: 1.05 },
  NW_REEF: { swell: 0.95, breakers: 1.1 },
  N_SHORE: { swell: 1 },
  BLACK_BEACH: { swell: 1.05 },
  LAVA_FLATS: { swell: 0.9 },
  E_MID: { swell: 0.85 },

  // --- exposed: windward coasts, offshore rock, open Pacific ---------------
  SE_SHALLOW_SURF: { swell: 1.15 },
  S_INTERTIDAL: { swell: 1.2 },
  SE_COAST: { swell: 1.2 },
  SW_BEACH: { swell: 1.3 },
  BLACK_BEACH_SURF: { swell: 1.35 },
  BEAGLE: { swell: 1.4, chop: 1.25 },
  DEVILS_CROWN: { swell: 1.5, chop: 1.3 },
  EL_MIRADOR: { swell: 1.6, chop: 1.35 },
  EASTERN_CLIFFS: { swell: 1.7, chop: 1.4 },
  N_OUTCROP: { swell: 1.7, chop: 1.45 },
  PUNTA_SUR: { swell: 1.8, chop: 1.45 },
});
