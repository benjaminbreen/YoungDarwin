...
export const DRY_FLOREANA_TEXTURE_SETS = {
  redDirtHighland: {
    redDirt: '/assets/textures/world/floreana-pbr/red-cinder-dirt_albedo.webp',
    redDirtNormal: '/assets/textures/world/floreana-pbr/red-cinder-dirt_normal.webp',
    redDirtRoughness: '/assets/textures/world/floreana-pbr/red-cinder-dirt_roughness.webp',
    redDirtHeight: '/assets/textures/world/floreana-pbr/red-cinder-dirt_height.webp',
    shoulderGround: '/assets/textures/world/floreana-pbr/coastal-grass-shoulder_albedo.webp',
    shoulderGroundNormal: '/assets/textures/world/floreana-pbr/coastal-grass-shoulder_normal.webp',
    shoulderGroundRoughness: '/assets/textures/world/floreana-pbr/coastal-grass-shoulder_roughness.webp',
    shoulderGroundHeight: '/assets/textures/world/floreana-pbr/coastal-grass-shoulder_height.webp',
    dryGrassGround: '/assets/textures/world/floreana-pbr/dry-grass-litter_albedo.webp',
    dryGrassGroundNormal: '/assets/textures/world/floreana-pbr/dry-grass-litter_normal.webp',
    dryGrassGroundRoughness: '/assets/textures/world/floreana-pbr/dry-grass-litter_roughness.webp',
    dryGrassGroundHeight: '/assets/textures/world/floreana-pbr/dry-grass-litter_height.webp',
    paleFlecks: '/assets/textures/world/floreana-pbr/olivine-beach_albedo.webp',
    paleFlecksNormal: '/assets/textures/world/floreana-pbr/olivine-beach_normal.webp',
    paleFlecksRoughness: '/assets/textures/world/floreana-pbr/olivine-beach_roughness.webp',
    paleFlecksHeight: '/assets/textures/world/floreana-pbr/olivine-beach_height.webp',
    fallbacks: {
      redDirt: '#a75b2e',
  ...
  sandyCoastal: {
    ...
    paleFlecksRoughness: '/assets/textures/world/floreana-pbr/olivine-beach_roughness.webp',
    paleFlecksHeight: '/assets/textures/world/floreana-pbr/olivine-beach_height.webp',
    baseSand: '/assets/textures/world/floreana-pbr/galapagos-sand_albedo.webp',
    baseSandNormal: '/assets/textures/world/floreana-pbr/galapagos-sand_normal.webp',
    baseSandRoughness: '/assets/textures/world/floreana-pbr/galapagos-sand_roughness.webp',
    baseSandHeight: '/assets/textures/world/floreana-pbr/galapagos-sand_height.webp',
    fallbacks: {
      redDirt: '#b47b3c',
