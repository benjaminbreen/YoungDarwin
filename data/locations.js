...
export const locations = [
  ...
  // 3) POST_OFFICE_BAY
  {
    ...
    description: 'A sheltered cove where sailors leave letters in a barrel and shorebirds cross the volcanic strand.',
    x: 1,
    y: 0,
    color: 'beige',
    type: 'bay',
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'post-office-lava-lizard-east',
        specimenId: 'lavalizard',
        position: [44, 0, 17],
        behavior: 'bask',
        sceneScale: 1.08,
      ...
      {
        instanceId: 'post-office-lavagull-west-shore',
        specimenId: 'lavagull',
        position: [-18, 0, 1],
        behavior: 'shorebird',
        sceneScale: 0.9,
    ...
    notableFeatures: [
      ...
      'A lone gull patrols the calm cove while insects work the flowering scrub.',
  ...
  // 7) N_OUTCROP
  {
    ...
    specimens: ['seaLion','marineIguana','crab','lavaLizard','cactus','short_eared_owl'],
    specimenPlacements: [
      {
        specimenId: 'seaLion',
        position: [3, 0, -19],
      ...
      {
        instanceId: 'outcrop-short-eared-owl-basalt-spine-1',
        specimenId: 'short_eared_owl',
        position: [0.38, 0, -13.33],
        behavior: 'dusk-hunt',
        sceneScale: 1,
        habitatRadiusX: 18,
        habitatRadiusZ: 22,
  ...
  // 10) LAVA_FLATS
  {
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'lava-flats-short-eared-owl-scoria-roost-1',
        specimenId: 'short_eared_owl',
        position: [31.8, 0, -13.8],
        behavior: 'dusk-hunt',
        sceneScale: 1,
        habitatRadiusX: 31,
        habitatRadiusZ: 24,
      ...
      {
        instanceId: 'lava-flats-floreana-racer-tube-rim-1',
        specimenId: 'galapagos_racer',
        position: [4, 0, 8],
        behavior: 'bask',
        sceneScale: 1,
        habitatRadiusX: 12,
      ...
      {
        instanceId: 'lava-flats-floreana-racer-pressure-lobe-2',
        specimenId: 'galapagos_racer',
        position: [-18, 0, 24],
        behavior: 'bask',
        sceneScale: 0.96,
      ...
      {
        instanceId: 'lava-flats-floreana-racer-tube-overflow-3',
        specimenId: 'galapagos_racer',
        position: [20, 0, 5],
        behavior: 'forage',
        sceneScale: 1.03,
  ...
  // 11) NORTHERN_HIGHLANDS
  {
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'northern-highlands-floreana-racer-seed-scrub-1',
        specimenId: 'galapagos_racer',
        position: [-8, 0, -4],
        behavior: 'forage',
        sceneScale: 0.94,
      ...
      {
        instanceId: 'northern-highlands-floreana-racer-garden-stones-2',
        specimenId: 'galapagos_racer',
        position: [18, 0, 20],
        behavior: 'bask',
        sceneScale: 1.02,
  ...
  // 13) COASTAL SCRUBLAND
  {
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'coastal-scrub-floreana-racer-saltbush-1',
        specimenId: 'galapagos_racer',
        position: [-5, 0, 8],
        behavior: 'bask',
        sceneScale: 0.96,
      ...
      {
        instanceId: 'coastal-scrub-floreana-racer-croton-2',
        specimenId: 'galapagos_racer',
        position: [23, 0, 2],
        behavior: 'forage',
        sceneScale: 1.04,
      ...
      {
        instanceId: 'coastal-scrub-floreana-racer-seep-edge-3',
        specimenId: 'galapagos_racer',
        position: [-20, 0, 27],
        behavior: 'forage',
        sceneScale: 0.92,
  ...
  // 16) W_HIGH
  {
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'western-highlands-galapagos-hawk-scalesia-perch-1',
        specimenId: 'galapagos_hawk',
        position: [-24.6, 0, 24.2],
        behavior: 'soar-and-tree-perch',
        sceneScale: 1,
        habitatRadiusX: 38,
        habitatRadiusZ: 32,
      },
  ...
  // 18) PENAL COLONY
  {
    ...
    specimens: ['medium_ground_finch','floreana_mockingbird','galapagos_dove','cat','feralgoat','feralhorse'],
    npcs: [],
    boundaries: {},
    specimenPlacements: [
      {
      ...
      {
        instanceId: 'penal-colony-galapagos-dove-garden-well-1',
        specimenId: 'galapagos_dove',
        position: [-2.8, 0, 9.4],
        behavior: 'forage-and-fly',
        sceneScale: 1,
        habitatRadiusX: 8.5,
        habitatRadiusZ: 5.4,
      },
  ...
  // 19) E_MID
  {
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'rocky-clearing-short-eared-owl-north-shelf-1',
        specimenId: 'short_eared_owl',
        position: [-18.6, 0, -17.2],
        behavior: 'dusk-hunt',
        sceneScale: 1,
        habitatRadiusX: 25,
        habitatRadiusZ: 18,
      ...
      {
        instanceId: 'rocky-clearing-floreana-racer-finch-edge-1',
        specimenId: 'galapagos_racer',
        position: [-11, 0, 7],
        behavior: 'forage',
        sceneScale: 1,
      ...
      {
        instanceId: 'rocky-clearing-floreana-racer-west-rubble-2',
        specimenId: 'galapagos_racer',
        position: [-24, 0, 4],
        behavior: 'bask',
        sceneScale: 0.95,
  ...
  // 22) SW_BEACH
  {
    ...
    description: 'A severe west-facing rookery where shell-white coves interrupt guano-streaked black lava and rounded volcanic hillocks rise inland.',
    x: 0,
    y: 3,
    color: '#8b4513',
    type: 'coastalTrail',
    ...
    specimenPlacements: [
      {
        instanceId: 'marine-colony-iguana-terrace-sentinel',
        specimenId: 'marineIguana',
        position: [-8.2, 0, 2.8],
        behavior: 'bask',
        sceneScale: 1.5,
      ...
      {
        instanceId: 'marine-colony-iguana-black-slab',
        specimenId: 'marineIguana',
        position: [-13.8, 0, 7.4],
        behavior: 'bask',
        sceneScale: 1.28,
      ...
      {
        instanceId: 'marine-colony-sally-lightfoot-tidepool',
        specimenId: 'crab',
        position: [-26.5, 0, -27.5],
        behavior: 'skitter',
        sceneScale: 1.08,
        habitatRadiusX: 4.6,
        habitatRadiusZ: 3.2,
    ...
    boundaries: { west: 'ocean' },
    discoveries: [
      'The colony announces itself first by smell: hot reptile skin, seaweed, brine, and guano concentrated on the black ledges.',
      'The iguanas lie pressed together for warmth, their dark bodies nearly disappearing against the lava until one raises its blunt head.'
    ],
    notableFeatures: [
      'Shell-white pocket beaches lie between broken fingers of black basalt.',
      'Generations of birds and reptiles have painted the warmest basking terraces with pale guano streaks.',
      'Ruddy Sally Lightfoot crabs work the tidepool margins among coral fragments and shell hash.',
      'Inland, wind-rounded cinder hillocks fold the routes north, east, and south out of sight.'
    ],
    narration: {
      weather: 'sunny',
      sounds: ['Pacific surf striking lava', 'claws rasping over basalt', 'the dry rattle of shell fragments'],
      loadingNote: 'White shell sand flashes between black lava terraces. Ahead, dozens of marine iguanas bask shoulder to shoulder above the western surf.',
      educationalNote: 'Darwin initially found marine iguanas ugly and sluggish, but carefully observed their swimming, feeding, and powerful adaptation to the Galápagos shore.',
    },
  },
  ...
  // 26) SE_COAST
  {
    ...
    description: 'Low dry scrub descends to a broken basalt shore exposed to the southeast trade wind.',
    x: 4,
    y: 3,
    color: '#66745a',
    type: 'coastallava',
    validMoves: ['N','W','E'],
    specimens: ['crab','marineIguana','lavaLizard','galapagoscotton','barnacle','basalt'],
    specimenPlacements: [
      {
        instanceId: 'southeast-coast-marine-iguana-central-shelf',
        specimenId: 'marineIguana',
        position: [22, 0, 4],
        behavior: 'bask',
        sceneScale: 1.04,
      ...
      {
        instanceId: 'southeast-coast-sally-lightfoot-notch',
        specimenId: 'crab',
        position: [29, 0, -18],
        behavior: 'skitter',
        sceneScale: 1.12,
      ...
      {
        instanceId: 'southeast-coast-lava-lizard-scrub-edge',
        specimenId: 'lavaLizard',
        position: [-13, 0, -4],
        behavior: 'scurry',
        sceneScale: 0.96,
    ...
    discoveries: [
      'Saltbush and low Croton thin toward a basalt platform cut by pools and narrow swash channels.'
    ],
    notableFeatures: [
      'Wind-pruned scrub reaches close to the spray line.',
      'Dark ledges and loose basalt form an irregular shore without a broad beach.',
      'Marine iguanas and Sally Lightfoot crabs use the wet rock between wave sets.'
    ],
    narration: {
      weather: 'windy',
      sounds: ['short waves breaking on basalt', 'wind moving through low scrub', 'coastal birds over the water'],
      loadingNote: 'The trail descends through dry scrub to Floreana\'s exposed southeastern shore.',
      educationalNote: 'Salt-tolerant coastal plants occupy the spray line while dry-zone shrubs grow a short distance inland.',
    },
  },
  ...
  // 27) SE_SHALLOW_SURF
  {
    id: 'SE_SHALLOW_SURF',
    name: 'Shallow Surf',
    description: 'A windward basalt shelf cut by wading channels and deeper water around scattered rocks.',
    x: 4,
    y: 4,
    color: '#3e7778',
    type: 'ocean',
    validMoves: ['W'],
    specimens: ['greenTurtle','parrotfish','seaLion','crab','barnacle'],
    specimenPlacements: [
      {
        instanceId: 'shallow-surf-green-turtle-channel',
        specimenId: 'greenTurtle',
        position: [5, 0, -10],
        behavior: 'still',
        sceneScale: 1.06,
      ...
      {
        instanceId: 'shallow-surf-parrotfish-ledge',
        specimenId: 'parrotfish',
        position: [12, 0, 17],
        behavior: 'still',
        sceneScale: 0.94,
      ...
      {
        instanceId: 'shallow-surf-sea-lion-inner-rock',
        specimenId: 'seaLion',
        position: [-31, 0, -18],
        behavior: 'bask',
        sceneScale: 1.08,
    ...
    npcs: [],
    boundaries: { north: 'ocean', south: 'ocean', east: 'ocean' },
    discoveries: [
      'Fish graze the algae on submerged basalt while a green turtle crosses the deeper channel.'
    ],
    notableFeatures: [
      'The western shelf remains wadeable between exposed rock heads.',
      'Broken ledges create short breakers and foam trails instead of a continuous surf line.',
      'Charcoal basalt gives way to blue-green swimming water toward the offshore edge.'
    ],
    narration: {
      weather: 'windy',
      sounds: ['water drawing back through basalt gaps', 'small breakers striking offshore rocks', 'boobies calling above the shelf'],
      loadingNote: 'The shore continues underwater as a shallow, broken basalt shelf.',
      educationalNote: 'Rocky reef and soft sediment occur together in Floreana\'s nearshore habitat.',
    },
  },
...
const finalRouteExtraLocations = [
  {
    ...
    specimenPlacements: [
      ...
      {
        instanceId: 'scrub-rise-floreana-racer-finch-fork-1',
        specimenId: 'galapagos_racer',
        position: [-9, 0, 17],
        behavior: 'forage',
        sceneScale: 1.02,
      ...
      {
        instanceId: 'scrub-rise-floreana-racer-wash-block-2',
        specimenId: 'galapagos_racer',
        position: [-19, 0, -11],
        behavior: 'bask',
        sceneScale: 0.94,
      ...
      {
        instanceId: 'scrub-rise-floreana-racer-east-croton-3',
        specimenId: 'galapagos_racer',
        position: [39, 0, -3],
        behavior: 'forage',
        sceneScale: 0.98,
  ...
  },
  {
    ...
    type: 'wetland',
    validMoves: [],
    specimens: ['mangrove', 'medium_ground_finch', 'galapagos_dove', 'floreana_giant_tortoise'],
    npcs: [],
    boundaries: {},
    specimenPlacements: [
      {
        instanceId: 'asilo-spring-galapagos-dove-water-edge-1',
        specimenId: 'galapagos_dove',
        position: [3.8, 0, 2.4],
        behavior: 'forage-and-fly',
        sceneScale: 1.04,
      ...
      {
        instanceId: 'asilo-spring-galapagos-dove-water-edge-2',
        specimenId: 'galapagos_dove',
        position: [-4.6, 0, -1.8],
        behavior: 'forage-and-fly',
        sceneScale: 0.96,
