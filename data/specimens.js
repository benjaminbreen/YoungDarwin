...
export const baseSpecimens = [
  ...
  {
    id: 'galapagospaintedlocust',
    name: 'Galápagos Painted Locust',
    latin: 'Schistocerca melanocera',
    ontology: 'Animal',
    order: 'Insect',
    sub_order: 'Grasshopper',
    description: 'A large endemic locust painted in charcoal, lemon yellow, and coral red, resting among dry-zone plants before springing across the lava.',
    details: [
      'Black and yellow bands break up the head and saddle-like pronotum',
      'A coral-red stripe and warm orange hind legs flash when it leaps',
      'Smoky folded wings carry a fine dark network of veins and pale flecks',
      'Powerful hind femora launch the insect several body lengths at the first close footfall',
      'An endemic herbivore found on Floreana from arid scrub into humid forest',
    ],
    habitat: 'lavafield, scrubland, highland undergrowth',
    collected: false,
    observations: [],
    scientificValue: 5,
    hybrid_ease: 4,
