...
const LABELS = {
  ...
  'runtime-big-opuntia.glb': 'Mature Floreana prickly pear',
  ...
  'runtime-galapagos-fern.glb': 'Floreana resurrection fern',
  ...
  'runtime-mangrove-tree.glb': 'Red mangrove',
  ...
  'runtime-saltgrass.glb': 'Seashore dropseed proxy',
